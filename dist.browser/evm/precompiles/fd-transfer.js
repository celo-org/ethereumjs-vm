        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fromAddress = new ethereumjs_util_1.Address(opts.data.slice(12, 32));
                    toAddress = new ethereumjs_util_1.Address(opts.data.slice(44, 64));
                    value = new BN(opts.data.slice(64, 96));
                    return [4 /*yield*/, incrementBalance(opts._VM.stateManager, fromAddress, value.neg())];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, incrementBalance(opts._VM.stateManager, toAddress, value)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, {
                            gasUsed: gasUsed,
