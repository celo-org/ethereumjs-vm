...
const numfe = require('./precompiled/fe-blockcoinbase.js')
...
function VM (opts = {}) {
  ...
  this._precompiled['00000000000000000000000000000000000000fd']
  this._precompiled['00000000000000000000000000000000000000fe'] = numfd
  ...
  if (this.opts.activatePrecompiles) {
    ...
    this.stateManager.trie.put(new BN(0xfe).toArrayLike(Buffer, 'be', 20), new Account().serialize())
  }
