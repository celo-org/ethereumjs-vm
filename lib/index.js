...
const numfc = require('./precompiled/fc-fractionmulexp.js')
...
function VM (opts = {}) {
  ...
  this._precompiled['00000000000000000000000000000000000000fd'] = numfc

  console.log('HERE NUMfc !!!!!', numfc)
  console.log('HERE NUMfd !!!!!', numfd)
  console.log('HERE NUMfd !!!!!', num08)
  ...
  if (this.opts.activatePrecompiles) {
    ...
    this.stateManager.trie.put(new BN(0xfd).toArrayLike(Buffer, 'be', 20), new Account().serialize())
    this.stateManager.trie.put(new BN(0xfc).toArrayLike(Buffer, 'be', 20), new Account().serialize())
  }
