...
const numfd = require('./evm/precompiles/fd-transfer.js')
const numfc = require('./evm/precompiles/fc-fractionmulexp.js')
const numf8 = require('./evm/precompiles/f8-epochsize.js')
...
module.exports = class VM extends AsyncEventEmitter {
  constructor (opts = {}) {
    ...
    this._precompiled['00000000000000000000000000000000000000f8'] = numf8
