...
var Loop = /** @class */ (function () {
    function Loop(vm, eei) {
        this._vm = vm; // TODO: remove when not needed
        this._state = new promisified_1.default(vm.stateManager);
        this._eei = eei;
        this._runState = {
            programCounter: 0,
            opCode: 0xfe,
    ...
    Loop.prototype.run = function (code, opts) {
        if (opts === void 0) { opts = {}; }
    ...
    Loop.prototype.runStep = function () {
        return __awaiter(this, void 0, void 0, function () {
            var opInfo, opFn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        opInfo = opcodes_1.lookupOpInfo(this._runState.opCode);
    ...
    Loop.prototype.getOpHandler = function (opInfo) {
        return opFns_js_1.handlers[opInfo.name];
    };
    Loop.prototype._runStepHook = function () {
        return __awaiter(this, void 0, void 0, function () {
            var eventObj;
            return __generator(this, function (_a) {
                eventObj = {
                    ...
                    opcode: opcodes_1.lookupOpInfo(this._runState.opCode, true),
    ...
    Loop.prototype._getValidJumpDests = function (code) {
        var jumps = [];
        for (var i = 0; i < code.length; i++) {
            var curOpCode = opcodes_1.lookupOpInfo(code[i]).name;
